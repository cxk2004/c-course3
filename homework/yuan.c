...
int  getThisMonday(int year, int daySeqOfYear)
{
    ...
    int thisMonday = daySeqOfYear - daySeqOfWeek + 1;
...
{
    int daySeqOfWeek = getDaySeqOfWeek( year, daySeqOfYear );
    int thisSunday = daySeqOfYear + 7 - daySeqOfWeek;
...
void printOneWeek(int year, int weekSeqOfYear, int weekSeqShow)
{
    int daySeqOfYear = ( weekSeqOfYear - 1 ) * 7 + 1;
    int daySeqOfWeek = getDaySeqOfWeek( year, daySeqOfYear );
    int thisMonday = getThisMonday( year, daySeqOfYear );
    int thisSunday = getThisSunday( year, daySeqOfYear );
    ...
    for ( i = 0; i < 7; i ++ )
    {
        ...
        if ( daySeqOfYear + i == 1 || daySeqOfYear + i == 365 )
        {
            printOneDay( year, daySeqOfYear + i, DATE_INFO_FULL );
        }
        else
        {
            printOneDay( year, daySeqOfYear + i, DATE_INFO_BRIEF );
        }
    }
